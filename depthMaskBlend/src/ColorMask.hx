...
class ColorMask extends Application
{
	...
	var buffer1:Buffer<ElementSimple>;
	var buffer2:Buffer<ElementSimple>;
	...
	{	
		...
		buffer1  = new Buffer<ElementSimple>(100);
		buffer2  = new Buffer<ElementSimple>(100);
		program1 = new Program(buffer1);
		...
		// program2.blendDst = BlendFactor.ZERO;
		// program2.blendSrcAlpha = BlendFactor.ONE_MINUS_SRC_ALPHA;
		// program2.discardAtAlpha();
		
		display.addProgram(program1);
		display.addProgram(program2);
		
		element1 = new ElementSimple(100, 100, 200, 200, 1); element1.z = 0;
		element2 = new ElementSimple(170, 100, 200, 200, 2); element2.z = 1;
		buffer1.addElement(element1);
		buffer1.addElement(element2);
		
		element3 = new ElementSimple(130, 170, 200, 200, 3); element3.z = 2;
		element4 = new ElementSimple(200, 170, 200, 200, 4); element3.z = 3;
		buffer2.addElement(element3);
		buffer2.addElement(element4);
	...
	override function onKeyDown (keyCode:KeyCode, modifier:KeyModifier):Void
	{
		switch (keyCode) {
			...
			case KeyCode.N: program1.colorEnabled = ! program1.colorEnabled; trace("program1.colorEnabled", program1.colorEnabled);
			case KeyCode.M: program2.colorEnabled = ! program2.colorEnabled; trace("program2.colorEnabled", program2.colorEnabled);
			case KeyCode.R: colorChanR = ! colorChanR; trace("red channel", colorChanR);
			case KeyCode.G: colorChanG = ! colorChanG; trace("green channel", colorChanG);
			case KeyCode.B: colorChanB = ! colorChanB; trace("blue channel", colorChanB);
			case KeyCode.A: colorChanA = ! colorChanA; trace("alpha channel", colorChanA);
			default:
		}

		program1.enableColorChannel(colorChanR, colorChanG, colorChanB, colorChanA);
		// program2.enableColorChannel(colorChanR, colorChanG, colorChanB, colorChanA);

		buffer1.update(); buffer2.update();
	}
